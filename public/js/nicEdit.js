...
var nicEditorConfig = bkClass.extend({
	...
	iconsPath : '/images/icon/nicEditIcons.gif',
...
var nicUploadButton = nicEditorAdvancedButton.extend({	
	...
	// nicURI:"../controller/image_upload.php",
	 nicURI:"/eftNews/imageUploadNicEditor",
...
var nicCodeOptions = {
	buttons : {
        ...
        'youTube': '/images/icon/youtubeicon.gif'
    }
...
var nicYouTubeButton = nicEditorAdvancedButton.extend({
    ...
    submit: function (e) {
        ...
        if (code.indexOf('youtu.be') > 0) {
            code = code.replace('youtu.be','youtube.com/embed/');
        }
