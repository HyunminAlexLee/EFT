...
<section id="notice" class="col-sm-10">
	...
	<div class="wow fadeInDown">
                   ...
                   EFT 뉴스
					...
					<div id = "galleryList" >
					<?php count ( $eftNewsList )?>
					
					<?php
					if (count ( $eftNewsList ) > 0) {
						?><div class="col-md-12">
						...
						foreach ( $eftNewsList as $eftNews ) {
							?>
							<div class="col-md-12">
							<div class="col-md-1"><?=$eftNews ['news_id']?></div>
						<div class="col-md-7">
						  <input type="button" class="j_button" value ="<?=$eftNews ['title']?>" onClick="parent.location='/eftNews/eftNewsDetail?news_id=<?=$eftNews['news_id']?>'"> 
                 
						</div>
						<div class="col-md-2"><?=$eftNews ['create_date']?></div>
						<div class="col-md-2"><?=$eftNews ['create_user']?></div>
				...
				$page_list_size = $newsPaging['page_list_size'];
				$total_page = $newsPaging ['total_page'];
				$current_page = $newsPaging ['current_page'];
				$page_size = $newsPaging ['page_size'];
				$first_no = $newsPaging ['first_no'];
				//echo $page_list_size;
...
<div><input type="button" class="j_button" value ="UPDATE" onClick="parent.location='/eftNews/eftNewsUpdate'"></div>
</section>
</div>
<!-- notice board -->
