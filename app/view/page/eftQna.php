...
<section id="qna" class="col-sm-10">
	...
	<div class="wow fadeInDown">
                   ...
                   EFT QNA
					...
					<div id = "qnaList" >
					<?php count ( $eftQnaList )?>
					
					<?php
					if (count ( $eftQnaList ) > 0) {
						?><div class="col-md-12">
						...
						foreach ( $eftQnaList as $eftQna ) {
							?>
							<div class="col-md-12">
							<div class="col-md-1"><?=$eftQna ['qna_id']?></div>
						<div class="col-md-7">
						  <input type="button" class="j_button" value ="<?=$eftQna ['title']?>" onClick="parent.location='/eftQna/eftQnaDetail?qna_id=<?=$eftQna['qna_id']?>'"> 
                 
						</div>
						<div class="col-md-2"><?=$eftQna ['create_date']?></div>
						<div class="col-md-2"><?=$eftQna ['create_user']?></div>
				...
				$page_list_size = $qnaPaging['page_list_size'];
				$total_page = $qnaPaging ['total_page'];
				$current_page = $qnaPaging ['current_page'];
				$page_size = $qnaPaging ['page_size'];
				$first_no = $qnaPaging ['first_no'];
				//echo $page_list_size;
...
<div><input type="button" class="j_button" value ="UPDATE" onClick="parent.location='/eftQna/eftQnaUpdate'"></div>
</section>
</div>
<!-- notice board -->
